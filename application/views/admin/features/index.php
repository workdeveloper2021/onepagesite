<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form action="<?= base_url('Adminfeatures/update')?>" method="post" enctype="multipart/form-data">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <input class="form-control" type="text" name="heading" value="<?= $features['heading']?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <label for="">Content :</label>
                            <textarea name="content" id="content"><?= $features['content']?></textarea>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div style="width:200px;heght:200px">
                                <img src="<?= base_url().$features['image']?>" alt="image" style="width:100%">
                            </div>
                        </div>
                        <div class="col-lg-6">
